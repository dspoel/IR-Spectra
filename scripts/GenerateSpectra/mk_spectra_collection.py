...
if __name__ == "__main__":
	...
	molecules = find_all_molecules(exp_dir, qm_dir, qms, ff_dir, ffs)
	...
	for molecule in molecules:
		...
		for qm in qms:
			if qm in molecule:
				current_qms.append(qm)
		for ff in ffs:
			if ff in molecule:
				current_ffs.append(ff)
		all_spectra[molecule[0]] = save_spectrum(exp_dir, qm_dir, current_qms, ff_dir, current_ffs, molecule[0], output_dir,
