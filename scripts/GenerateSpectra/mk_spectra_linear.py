...
parser.add_argument('-n'         , type=int  , default=4001            , help='Number of points on the frequency axis. DEFAULT: 1001')
...
if __name__ == "__main__":
	...
	molecules = find_molecules_linear(ff_dir, ffs)
	...
	for molecule in molecules:
		...
		all_spectra[molecule] = save_spectrum_linear(exp_dir, ff_dir, ffs, molecule, output_dir,
